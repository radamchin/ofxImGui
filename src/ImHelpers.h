...
namespace ofxImGui
{
	...
	bool AddParameter(ofParameter<ofColor>& parameter, bool alpha = true, ImGuiColorEditFlags flags = 0);
	bool AddParameter(ofParameter<ofFloatColor>& parameter, bool alpha = true, ImGuiColorEditFlags flags = 0);
