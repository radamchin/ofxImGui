...
#if !defined( TARGET_OPENGLES )
	std::cout << "Window 1 = (ofAppBaseWindow)" << window1.get() << " // (ofAppGLFWWindow)" << (ofAppBaseWindow*) window1.get() << " // (GLFWwindow)" << ((ofAppGLFWWindow*) window1.get())->getGLFWWindow() << std::endl;
	std::cout << "Window 2 = (ofAppBaseWindow)" << window2.get() << " // (ofAppGLFWWindow)" << (ofAppBaseWindow*) window2.get() << " // (GLFWwindow)" << ((ofAppGLFWWindow*) window2.get())->getGLFWWindow() << std::endl;
#else
